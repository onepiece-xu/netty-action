                ...
                <el-col :span="12">
                    <div class="table-content" style="margin-top:50px">
                        <el-table ref="multipleTable" 
                            ...
                            <el-table-column prop="count" label="连接数（次）" sortable>
                                <template slot-scope="scope">
...
<script>
import {getAppsConnectionsStatistics,getAppsConnectionsRealTime,getAppsConnectionsRealTimeTopTen,getAppsConnectionsStatisticsTopTen} from '@/public/api/statistics.js'
export default {
    data(){
        return {
            multipleSelection: [],
    ...
    methods:{
        handleSizeChange(val) {
            ...
            if(this.history == 1){
                ...
                this.initData(startTime,startTime,'day');
            }else{
                startTime = moment().subtract((this.history-1), "days").format("YYYY-MM-DD");
                endTime = moment().format("YYYY-MM-DD");
                this.initData(startTime,endTime,'week');
            }
            // this.initData();
        },
        ...
        initData(start,end,type){
            ...
            if(type == 'day'){
                getAppsConnectionsRealTime(oData).then((res) =>{
                    if(res&&res.data){
                ...
                getAppsConnectionsRealTimeTopTen().then((res) =>{
                    if(res&&res.data){
                ...
                oData.startTime = start
                oData.endTime = end
                getAppsConnectionsStatistics(oData).then((res) =>{
                    if(res&&res.data){
                ...
                getAppsConnectionsStatisticsTopTen(data).then((res) =>{
                    if(res&&res.data){
                        this.dataList1 = res.data;
                        let obj = []
                        let obj1 = []
    ...
    mounted(){
        ...
        this.initData(startTime,endTime,'day');
    }
}
</script>
