...
//	@Test
    public void generateCode() {
        //指定包名
        String packageName = "com.ydw.control";
        //指定生成的表名
...
//                .setDbColumnUnderline(true)
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://192.168.1.201:3306/ctp_paas?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false&serverTimezone=GMT%2B8";
        return new DataSourceConfig().setDbType(DbType.MYSQL)
                .setUrl(dbUrl)
                .setUsername("root")
                .setPassword("yidianwan")
