...
public class MeterageServiceImpl extends ServiceImpl<MeterageMapper, Meterage> implements IMeterageService {
    ...
    @Override
    public ResultInfo getMeterageList(List<String> clusterIds, String search, Integer status, String beginDate, String endDate, Page buildPage) {
        ...
        IPage page = meterageMapper.getMeterageList(clusterIds, search, status, beginDateTime, endDateTime, buildPage);
        return ResultInfo.success(page);
    }

    @Override
    public ResultInfo getMeterageCount(List<String> clusterIds, String search, Integer status, String beginDate, String endDate) {
        LocalDateTime beginDateTime = null;
        LocalDateTime endDateTime = null;
        if (StringUtil.isNotBlank(beginDate) && StringUtil.isNotBlank(endDate)){
            DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        ...
        Map<String, Integer> map = meterageMapper.getMeterageCount(clusterIds, search, status, beginDateTime, endDateTime);
